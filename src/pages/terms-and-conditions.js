  ...
  return (
    <Layout>
      <PolicyContainer>
        ...
        <h3>9.1. Disclaimers Regarding Recipe Content</h3>
        <p>
          You acknowledge that all recipes and related content ("Recipe Content") provided through the Service may be generated by artificial intelligence, curated by our staff, or sourced from third parties. While content generated by artificial intelligence will be clearly marked as such, all disclaimers in these Terms apply to <strong>all Recipe Content, regardless of its source.</strong>
        </p>
        <p>
          All Recipe Content is provided for informational purposes only. We make no warranties regarding the accuracy, reliability, completeness, safety, or usefulness of any Recipe Content. <strong>Your reliance on any Recipe Content is strictly at your own risk.</strong> As a condition of using the Service, you acknowledge and agree that you are fully and solely responsible for your actions and their consequences. This includes, but is not limited to, verifying all ingredients for allergens or other health risks, adhering to safe food handling and preparation practices, and cooking all food to appropriate internal temperatures. The Recipe Content is not a substitute for professional advice from a qualified chef, nutritionist, or medical professional. We expressly disclaim all liability for any adverse reactions, illness, injury, or other damages that may result from your use of, or reliance on, any Recipe Content. The disclaimers in this section are in addition to, and do not limit, the general disclaimers in Section 9, and the "Limitation of Liability" (Section 10) and "Indemnification" (Section 11) clauses of these Terms fully apply to your use of Recipe Content.
        </p>
